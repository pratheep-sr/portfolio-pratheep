          ...
          try {
            ...
            return (
              ...
              void (
                ...
                (this.el.style.background = Object(n.b)(
                  this.options.backgroundColor
                )))
              )
            );
    ...
    18: function (e, t, i) {
      ...
      var y = function (e, t, i, n) {
        ...
        s.add(b),
          ...
          (this.renderTexture = function (e, t) {
            (g.passThruTexture.value = e),
              this.doRenderTarget(w, t),
      ...
      const C = function (e) {
          (z = function (t = {}) {
            ...
            (z.prototype = Object.create(e.Geometry.prototype)),
            (S = function (t) {
              var i,
                n,
                o = new e.Vector3(),
            ...
            (e.BirdGeometry = function (t) {
              ...
              for (l = 0; l < 3 * i; l++) {
                ...
                let u;
                (u = !c && d[h] ? d[h] : t.effect.getNewCol(o)),
                  c || d[h] || (d[h] = u),
                  (s.array[3 * l + 0] = u.r),
                  (s.array[3 * l + 1] = u.g),
                  (s.array[3 * l + 2] = u.b),
      ...
      class A extends n.b {
            ...
            for (var s = 0; s < l; s++) {
              ...
              for (var r = 0; r < c.faces.length; r++)
                if (h)
                  ...
                  (c.faces[r].vertexColors[0] = e),
                    (c.faces[r].vertexColors[1] = e),
                    (c.faces[r].vertexColors[2] = e);
                }
              (o = e[s] =
                new g.Mesh(
                  c,
        ...
        onUpdate() {
          ...
          if ((e > 1 && (e = 1), (this.last = this.now), w))
        ...
        onMouseMove(e, t) {
          if (((this.mouseX = e - 0.5), (this.mouseY = t - 0.5), !w)) {
            const e = this.boids;
            let t;
            for (
              var i = new g.Vector3(
